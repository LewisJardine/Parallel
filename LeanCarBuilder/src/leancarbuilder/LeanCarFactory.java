...
public class LeanCarFactory {
	...
	public static void main(String[] args) {
		...
		One2OneChannel engines = channelFactory.createOne2One(new Buffer(1));
		One2OneChannel coachwork = channelFactory.createOne2One(new Buffer(1));
		One2OneChannel wheels = channelFactory.createOne2One(new Buffer(1));
		One2OneChannel assemblies = channelFactory.createOne2One(new Buffer(5));
